...
export default function DashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-slate-50 relative">
      ...
      {!isAuthed && (
        <div className="relative mx-4 w-full max-w-md rounded-3xl border border-slate-700/80
    bg-gradient-to-b from-slate-950/95 via-slate-900/95 to-slate-950/98 px-8 py-7
    shadow-[0_30px_120px_rgba(0,0,0,0.9)] hover:shadow-[0_40px_140px_rgba(0,0,0,0.95)]
    ring-1 ring-emerald-400/25 text-center transition-shadow duration-300">
