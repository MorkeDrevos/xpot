...
function getMadridOffsetMs(now = new Date()) {
  // trick: interpret Madrid wall-clock as UTC, compare to real UTC
...
function getNextMadridCutoffUtcMs(cutoffHour = 22, now = new Date()) {
  ...
  if (now.getTime() >= targetUtc) {
    // move to next day in Madrid wall-clock
...
export default function HomePage() {
  ...
  return (
    <XpotPageShell pageTag="home">
      {/* FULL-WIDTH HERO STAGE (edge-to-edge) */}
      <section className="relative">
        {/* full-bleed wrapper inside max-width shell */}
            ...
            <div className="relative z-10 mx-auto w-full max-w-[1440px] px-4 sm:px-6">
              <div className="py-6 sm:py-8">
                <div className="relative overflow-hidden rounded-[38px] border border-slate-900/70 bg-slate-950/45 shadow-[0_40px_140px_rgba(0,0,0,0.65)] backdrop-blur-xl">
                  ...
                  {/* hero layout: make the engine the star */}
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div>
                            ...
                            <p className="mt-1 text-xs text-slate-400">
                              Pool value, momentum and milestones. <span className="text-slate-500">(backup auto-engages)</span>
                            </p>
                          </div>
...
> LAST_WINNERS
  ...
  #2025-12-17  @NFAResearch     1,000,000 XPOT`}
            ...
            {/* bottom fade so the stage melts into the page */}
