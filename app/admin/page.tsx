...
export default function AdminPage() {
  ...
  async function handleCancelBonusDrop(dropId: string) {
    ...
    try {
      // matches your existing pattern (bonus-fire uses ?id=)
      const data = await authedFetch(`/api/admin/bonus-cancel?id=${encodeURIComponent(dropId)}`, {
        method: 'POST',
      });
        ...
        <header className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col items-start gap-1 sm:items-end">
            ...
            <p className="text-[11px] text-slate-400">
              Monitor pool state, entries and rewards. All data is live and securely gated behind your admin key.
            </p>
          </div>
        </header>
                        ...
                        return (
                          ...
                          >
                            <div className="flex flex-col gap-0.5">
                              ...
                              <span className="font-mono text-slate-400">{formatDateTime(d.scheduledAt)}</span>
                            </div>

                            <div className="flex items-center gap-2">
                              <span className="font-mono text-slate-200">{d.amountXpot.toLocaleString()} XPOT</span>
          ...
          <div className="w-full space-y-4 lg:max-w-[640px]">
            ...
            >
              <div className="relative mb-4 flex items-center justify-between gap-3">
                <div>
                  <p className="text-base font-semibold text-white tracking-wide">Recent XPOT winners</p>
