...
export default function FinalDayPage() {
  ...
  // Reusable articles (prevents the "blank bar" bug from placeholders)
  const ArchiveArticle = ({ className, style, ariaHidden }: { className: string; style?: React.CSSProperties; ariaHidden?: boolean }) => (
    <article
      id="xpot-fd-archive"
      ...
      <div className="pt-1">
        ...
        <div className="mt-5 grid grid-cols-[1fr_1fr_1.25fr] gap-4 max-[980px]:grid-cols-2 max-[860px]:grid-cols-1">
          ...
          <div>
            ...
            <p className="mt-3 text-[15px] leading-[1.62]">
              When it hits zero, a winner is chosen. Someone ordinary. Someone unknown. Someone who will carry the last number like a scar and a medal
              at the same time.
            </p>
          ...
          <div className="max-[980px]:col-span-2 max-[860px]:col-span-1">
            ...
            <p className="mt-3 text-[15px] leading-[1.62]">
              The people behind it are rarely discussed as personalities. Instead, they are remembered as a decision: the decision to stop. The decision
              to refuse inflation. The decision to never move the goalposts, even when the world begged for “more”.
            </p>
            <p className="mt-3 text-[15px] leading-[1.62]">
  ...
  const NowArticle = ({ className, style, ariaHidden }: { className: string; style?: React.CSSProperties; ariaHidden?: boolean }) => (
    <article
      id="xpot-fd-now"
      aria-hidden={ariaHidden}
      className={className}
