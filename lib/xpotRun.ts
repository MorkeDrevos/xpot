...
// ✅ Fresh run start: 2025-12-30 22:00 Madrid
export const RUN_START = { y: 2025, m: 12, d: 30, hh: 22, mm: 0 } as const;
 ...
 *
 * If Day 1 starts exactly at RUN_START (22:00 Madrid),
 * then the Final Draw happens after RUN_DAYS full days:
 * RUN_END = RUN_START date + RUN_DAYS (same cutoff time).
 */
...
export const RUN_START_EU = formatEuDateTime(RUN_START, {
  withTzLabel: true,
  tzLabel: 'Madrid',
});
export const RUN_END_EU = formatEuDateTime(RUN_END, {
  withTzLabel: true,
  tzLabel: 'Madrid',
});
