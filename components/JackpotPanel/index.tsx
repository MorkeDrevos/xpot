  ...
  return (
    <section className={`relative transition-colors duration-300 ${panelChrome}`}>
      <div>
        ...
        >
          {/* Background layers are in your CSS/style block already */}
          ...
          {/* keep your big style block exactly as-is in the file you already moved it to
              if you DIDN’T move it, paste your existing <style jsx> block here unchanged. */}
        </div>
