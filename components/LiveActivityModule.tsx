    ...
    >
      ...
      <div className="relative flex items-start justify-between gap-4 px-6 pt-6">
        <div>
          ...
          <div className="mt-1 text-[18px] font-semibold text-slate-100">{title}</div>
        </div>
      ...
      <div className="relative mt-5 px-6 pb-6">
        ...
        >
          ...
          {/* Premium seam divider (looks like one module, not two cards) */}
          <div className="relative px-4 sm:px-5">
            <div className="pointer-events-none h-px w-full bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.08),rgba(var(--xpot-gold),0.18),rgba(56,189,248,0.12),rgba(255,255,255,0.08),transparent)] opacity-80" />
          </div>

          {/* Entering lane (embedded - no outer card) */}
          <div className="relative px-4 py-4 sm:px-5">
            <EnteringStageLive
              entries={entries}
              embedded
