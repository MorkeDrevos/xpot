...
function XpotSignInModal({
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {open && (
          <Modal open={open} onClose={() => setOpen(false)} title="Sign in to XPOT">
            <motion.div
              key="xpot-signin"
            ...
            >
              ...
              {/* Clerk UI embedded INSIDE our modal (no Clerk popup) */}
              <SignIn
                routing="hash"
                appearance={{
                  variables: {
